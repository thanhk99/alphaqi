...
export default function AssetManagementReportsPage() {
            ...
            <div className={styles.pageContainer}>
                <section className={styles.hero}>
                    <div className="container">
                        <h1 className={styles.heroTitle}>Báo cáo Quản lý gia sản</h1>
                        <p className={styles.heroSubtitle}>Thông tin định kỳ giúp tối ưu hóa danh mục đầu tư gia đình.</p>
                    </div>
                </section>
                ...
                <div className="container">
                    ...
                    <ReportList type="ASSET_MANAGEMENT" />
                </div>
            </div>
        </MainLayout>
    );
