            ...
            <div className={styles.pageContainer}>
                <section className={styles.hero}>
                    <div className="container">
                        <h1 className={styles.heroTitle}>Báo cáo Công ty & Ngành</h1>
                        <p className={styles.heroSubtitle}>Phân tích chi tiết các doanh nghiệp và xu hướng ngành nghề.</p>
                    </div>
                </section>
                ...
                <div className="container">
                    ...
                    <ReportList type="COMPANY_INDUSTRY" />
                </div>
            </div>
        </MainLayout>
    );
