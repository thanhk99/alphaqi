            ...
            <div className={styles.pageContainer}>
                <section className={styles.hero}>
                    <div className="container">
                        <h1 className={styles.heroTitle}>Báo cáo Vĩ mô</h1>
                        <p className={styles.heroSubtitle}>Phân tích tình hình kinh tế vĩ mô trong nước và quốc tế.</p>
                    </div>
                </section>
